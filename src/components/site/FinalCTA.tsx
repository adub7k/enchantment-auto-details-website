...
export function FinalCTA({
  heading = "Ready to get it detailed?",
  body = "Tell us the vehicle and the package — or the state it's in. You'll get a straight recommendation and one number, and we'll say when Bronze is enough.",
  location = "final-cta",
  service,
}: {
  heading?: string;
