import { FileCheck, Droplets, Layers, Car, Star, ShieldCheck } from "lucide-react";
 ...
 * the owner hasn't confirmed, so an unverified guarantee or certification
