 ...
 *
 * EMPTY ON PURPOSE. The shop's Google rating and count weren't available at
 * build time, so nothing rating-related renders until there are real ones
 * here AND site.reviews.count is set — see LAUNCH.md.
 *
