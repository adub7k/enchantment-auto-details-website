...
const localBusinessLd = JSON.stringify({
  ...
  address: {
    ...
    ...(site.business.addressParts.street
      ...
      : {}),
    ...(site.business.addressParts.city
  ...
  areaServed: [site.serviceArea.primary, ...site.serviceArea.nearby].map((name) => ({
    "@type": site.business.addressParts.city ? "City" : "State",
    name,
  })),
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#141213" },
      { name: "format-detection", content: "telephone=no" },
      {
        title: `${site.business.name} — Car Detailing in ${CITY_STATE}`,
      },
      {
        name: "description",
        content: `Hand car detailing in ${CITY_STATE}: Bronze, Silver and Gold full details, interior-only details and spot-free foam washes. One number before we start. Free quote.`,
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        // Oswald 500/600 for display, Inter 400/500/600 for body and UI.
