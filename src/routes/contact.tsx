...
const PATH = "/contact";
const TITLE = `Contact Enchantment Auto Details — ${CITY_STATE}`;
const DESC = `Get in touch with Enchantment Auto Details in ${CITY_STATE} for a full detail, an interior detail or a foam wash. Send a quote request or call.`;
const CRUMBS = [
  { name: "Home", path: "/" },
          ...
          <div className="mt-8 grid gap-10 lg:grid-cols-[1fr_1.2fr] lg:gap-16">
            <div className="animate-rise">
              ...
              <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
                Tell us the vehicle and the package — or just the state it's in — and we'll come
                back with a number and a time. The form is the quickest route.
              </p>
