...
const PATH = "/gallery";
const TITLE = `Our Work — Car Detailing Photos | Enchantment Auto Details`;
const DESC = `Real details from Enchantment Auto Details in ${CITY_STATE}. Full details, interiors and washes — our own work, no stock photography.`;
const CRUMBS = [
  { name: "Home", path: "/" },
  ...
  return (
    <SiteLayout>
      <section className="pt-[4.5rem]">
        <div className="container-x pb-6 pt-8 sm:pt-12">
          ...
          <div className="mt-8 max-w-2xl animate-rise">
            ...
            <h1 className="mt-4">Cars that have left the shop.</h1>
            <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
              Every photo here is our own work — customers' cars, our hands. Nothing on this site is
              stock photography or another shop's portfolio.
            </p>
          </div>
        </div>
      </section>
      ...
      <FinalCTA
        ...
        body="Tell us the vehicle and what it needs. We'll come back with a package and a number."
