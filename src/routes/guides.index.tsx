...
const PATH = "/guides";
const TITLE = "Guides — Car Detailing Advice for New Mexico | Enchantment Auto Details";
const DESC = `Straight answers on detailing a car in ${CITY_STATE}: which package, dust and hard water, sun-faded trim, hand wash vs the tunnel — written by a detailer, not a sales page.`;
const CRUMBS = [
  { name: "Home", path: "/" },
  ...
  return (
    <SiteLayout>
      ...
      <FinalCTA
        ...
        body="Tell us the vehicle and what it needs — you'll get a number, not a range."
