...
const TITLE = `Car Detailing in ${CITY_STATE} | Bronze, Silver & Gold Details — Enchantment Auto Details`;
const DESC = `Hand car detailing in ${CITY_STATE}. Full inside-and-out details in three packages, interior-only details and spot-free foam washes. One number before we start. Free quote.`;
...
export const Route = createFileRoute("/")({
  head: () => {
    ...
    return {
      ...
      links: [
        ...s.links,
        // The logo artwork is the hero's LCP image.
        {
          rel: "preload",
          as: "image",
          href: "/img/enchantment-hero.webp",
          fetchPriority: "high",
        },
      ],
    ...
    <SiteLayout>
      ...
      <Section id="services">
        <div className="container-x">
          <SectionHead
            eyebrow="What we do"
            title="Three ways to get it clean."
            body="A full detail in three depths, the inside on its own, or a proper wash. Same spot-free standard on all of it."
          />
          <ServiceGrid />
        </div>
      </Section>
      ...
      <Section tone="raised">
        <div className="container-x">
          <SectionHead
            ...
            body="Nothing here we can't back up on day one. If something matters to you that isn't on this list, ask — you'll get a straight answer."
          />
      ...
      <WorkSection
        eyebrow="Real work"
        title="Cars that have actually left the shop."
      ...
      <Section className="cv-auto">
        <div className="container-x">
          <SectionHead
            ...
            title="From first message to the walk-around."
