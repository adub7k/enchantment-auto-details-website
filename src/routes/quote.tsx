...
import { Phone, Clock, MapPin, ShieldCheck, Camera } from "lucide-react";
...
const PATH = "/quote";
const TITLE = `Get a Free Quote | Enchantment Auto Details — ${CITY_STATE}`;
const DESC =
  "Tell us the vehicle and the package — Bronze, Silver, Gold, interior or a wash — and we'll come back with one number and a time. No pressure, no obligation.";
const CRUMBS = [
  { name: "Home", path: "/" },
...
const assurances = [
  ...
  { icon: Camera, text: "Photos of the worst spots get you the most accurate number" },
];
          ...
          <div className="mt-8 grid gap-10 lg:grid-cols-[1fr_1.3fr] lg:gap-16">
            <div className="animate-rise">
              ...
              <h1 className="mt-4 text-[clamp(1.9rem,4.4vw,3rem)]">
                Tell us the car. We'll tell you the number.
              </h1>
              <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
                Five short steps, about a minute. You'll get a straight recommendation and one
                number — including when Bronze is the right call.
              </p>
